...
file_path = '/content/verbosNOS.csv'
...
plt.bar(grouped_verbs['VERBOS'], grouped_verbs['Oco'], color='yellowgreen')
plt.xlabel('Verbo')
plt.ylabel('Número de Ocorrências')
plt.title(f'Top {top_n_verbs} Ocorrências de Verbos no Jornal Nós')
